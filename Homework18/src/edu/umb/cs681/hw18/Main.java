...
public class Main {
    ...
    public static void main(String[] args) {
    	long t1,t2;
        System.out.printf("CS681 Homework 18\n");
        ...
        System.out.printf("\tStream : The price range of the %d cars you considered is from %.2f to %.2f.\n",
                          carCount, maxCarPrice, minCarPrice);
        t2 = System.currentTimeMillis();
        System.out.println("\tStream Time Taken?= " + (t2-t1) + "\n");
        t1 = System.currentTimeMillis();
        carCount = getCarCount(Stream.of(cars).parallel());
        maxCarPrice = getXmostCarPrice(Stream.of(cars).parallel(), Float::max).get();
        minCarPrice = getXmostCarPrice(Stream.of(cars).parallel(), Float::min).get();

        System.out.printf("\tParallel Stream : The price range of the %d cars you considered is from %.2f to %.2f.\n",
                          carCount, maxCarPrice, minCarPrice);
        t2 = System.currentTimeMillis();
